    ...
    <>
      <div className="introduce-codingon-container">
        ...
        <div className="paragraph">
          ...
          reinforcement training, and application training so that they can be
          used directly in practice, and help companies secure competitiveness
          by fostering these talents.
        </div>
        <div className="paragraph">
          Provide quality SW education to both students and teachers in line
          with government education policies. It provides a roadmap according to
          SW content and learning purpose in preparation for the 4th industry.
          In addition, it supports career advancement design, comparison and
        ...
        <div className="paragraph">
          ...
          education that can be accessed anytime, anywhere by all ages, such as
          text coding for middle and high school students and professional SW
